      ...
      // Swiper of different pages
        <View style={styles.container}>
          ...
          <View style={styles.image}>
            <Image source={require('./source/1.png')} style={stylesImage.container}></Image>
          </View>
          <Text style={stylesText.title}>Schritt 1</Text>
          <View style={{position:'absolute', top:Dimensions.get('window').height*0.40}}>
            <View style={styles.text}>
            <Text style ={stylesText.text}>
            Fixiere den HandsOff Controller direkt neben deinem Griff. Überprüfe, ob du alle Knöpfe mit Daumen oder Zeigefinger komfortabel erreichen kannst. Passe bei Bedarf die Position entsprechend an.
            </Text>
            </View>
          </View>
          <View style={{alignItems:'center',position:'relative',top:Dimensions.get('window').height*0.27}}>
            <TouchableOpacity onPress={()=> this.props.navigation.navigate('Guideline_2')} style={stylesButton.main}>
