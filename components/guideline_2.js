    ...
    return (
        <View style={styles.container}>
          ...
          <View style={styles.image}>
            <Image source={require('./source/2.png')} style={stylesImage.container}></Image>
          </View>
          <Text style={stylesText.title}> Schritt 2</Text>
          <View style={{position:'absolute', top:Dimensions.get('window').height*0.40}}>
            <View style={styles.text}>
            <Text style ={stylesText.text}>
            Verbinde dein Smartphone mit dem HandsOff Controller und warte auf die Bestätigung.
            </Text>
            </View>
          </View>
          <View style={{alignItems:'center',position:'relative',top:Dimensions.get('window').height*0.27}}>
            <TouchableOpacity onPress={()=> this.props.navigation.navigate('Guideline_3')} style={stylesButton.main}>
